...
const svgPhoto = {
    male: [Boy, Man, Man2, GentleMan, BusinnessMan],
    female: [Girl, Woen2, Women]
}
...
const RandomPictures: React.FC<{gender: string, width: string, height: string}> = ({gender, width, height})=>{
